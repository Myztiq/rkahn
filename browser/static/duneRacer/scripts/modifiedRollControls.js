...
THREE.ModifiedRollControls = function ( object, domElement ) {
  ...
  this.domElement.addEventListener('mouseout',onMouseOff,false);
  this.domElement.addEventListener('mouseover',onMouseOn,false);
